...
☐ Реализовать функционал, описанный ниже (см. раздел Функциональные требования ↓).
...
o	Active tasks — отображает количество задач в списке Backlog.
o	Finished tasks — отображает количество задач в списке Finished.
